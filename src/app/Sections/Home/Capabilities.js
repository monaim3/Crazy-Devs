...
const capabilities = [
  {
    id: 'web',
    title: 'WEB',
    images: [php, javascript, react,Djangu,angular,mysql,nodejs,laraval,NextJs],
  },
  {
    id: 'mobile',
    title: 'MOBILE',
...
export default function Capabilities() {
    ...
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
                ...
                {capability.icon && (
                  <capability.icon
                    className={`w-5 h-5 mr-2 ${
                      activeTab === capability.id ? 'text-white' : 'text-primary'
                    }`}
                  />
                )}
          ...
          {/* Content Area */}
          <div className="space-y-6 image-tab">
  
  <div className="grid grid-cols-2 gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 lg:px-56 lg:gap-0.5 mb-4">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 lg:px-[300px]">
