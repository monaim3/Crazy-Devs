...
import { Monitor, Smartphone, Cloud, LineChart, Box, Users } from "lucide-react";
    ...
    return (
        <div className="flex flex-col items-center text-center mb-6 ">
            <div className="h-12 w-12 mb-4 flex items-center justify-center">
                <Image src={service.image} alt="Service Image" className="w-full h-full" />
            </div>
            <h3 className="text-md font-medium text-slate-900 ">   {titleLines.map((line, index) => (
                <span key={index}>
                    {line.trim()}
...
export default function Business() {
    return (
        ...
        <main className="bg-[#FEF4EA]  py-12 px-8">
            ...
            <section className="bg-white  mx-auto px-4 flex flex-col md:flex-row gap-4">
                ...
                <div className="p-8 rounded-lg  lg:w-2/4">
                    ...
                    <p className="text-slate-600 mb-4">
                        The Starter edition of every Drazydevs product, bundled together at a
                        discounted price for your startup or small business. Find and reach
                        customers, grow sales and get paid faster, and organize customer data.
                    </p>
