          ...
          <div className="flex flex-wrap justify-center gap-2 mb-12 bg-[#F5F5F5] py-4 rounded-md">
            {capabilities.map((capability) => (
              <button
                ...
                className={`flex items-center px-4 py-2 rounded-b-lg rounded-t-lg transition-all duration-300 ${activeTab === capability.id
              ...
              >
                {capability.icon && (
                  <capability.icon
                    className={`w-5 h-5 mr-2 ${activeTab === capability.id ? 'text-white' : 'text-primary'
                      }`}
                  />
                )}
